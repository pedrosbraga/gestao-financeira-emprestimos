...
-- This file contains initial data for the loan management system

-- Insert initial users (these will be created after auth.users are created)
-- Note: In production, users should be created through Supabase Auth first

-- Sample clients for testing
INSERT INTO public.clients (id, name, document, phone, address, references) VALUES
(
...
-- Sample loans for testing (will be inserted after users are created)
-- These are examples and should be adjusted based on actual user IDs
...
-- 4. Insert user records in public.users table
-- 5. Run: SELECT create_sample_data('your-ceo-user-id-here');
